          ...
          <Card id="about-card">
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                decided to pivot his passion for tech into a career. As project
                manager, he developed LastCall's project plan, directed the
                group's daily activities, and prioritized tasks. Michael is
                currently looking to contribute to an established team and to
          ...
          <Card id="about-card">
            ...
            <Card.Body>
              ...
              <Card.Text>
                ...
                functionality to applications. His background as both an
                educator and civil servant will provide unique solutions to
                unique problems in the industry. He is passionate about creating
                a better experience through understanding the nuances of any
                given task and creating the optimal solution. He is always eager
                to learn more and continue expanding the limits of his
                capabilities. Looking for a team to work on a project together
                to create new ways of adding value to any field. His most recent
                work as a tutor helped bridge the gap for many wanting to
                transition into a different field by offering targeted lessons
                plans pertaining to their future profession.
              </Card.Text>
            </Card.Body>
          </Card>
        </div>
